...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, kernel_size, num_classes, grayscale=0):
        ...
        self.conv1 = nn.Conv2d(in_dim, 16, kernel_size=kernel_size, stride=1, padding=1, bias=False)
...
class BottomModelForMnist(nn.Module):
    def __init__(self):
        ...
        self.fc1 = torch.nn.Linear(14 * 28, 256)
...
class TopModelForMnist(nn.Module):
    def __init__(self, labels=10):
        ...
        self.fc1top = torch.nn.Linear(64, 32)
        # self.fc2top = torch.nn.Linear(32, 32)
        self.fc3top = torch.nn.Linear(32, labels)
        # self.bn0top = nn.BatchNorm1d(64)
...
class BottomModelForM10(nn.Module):
    def __init__(self):
        super(BottomModelForM10, self).__init__()
        self.resnet20 = ResNet(block=BasicBlock, num_blocks=[3, 3, 3], kernel_size=(3, 3), num_classes=10, grayscale=1)
...
class TopModelForM10(nn.Module):
    def __init__(self):
        super(TopModelForM10, self).__init__()
